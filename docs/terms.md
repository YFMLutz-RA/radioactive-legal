...
You must be at least 13 years old to use the Service. If you are under the age of 18, you represent that you have obtained permission from a parent or legal guardian to use the Service.
...
From time to time, the Station App may include optional features or offerings (“Optional Features”) that participating Stations may choose to enable or make available to users.

Optional Features may include participation opportunities, promotions, or rewards offered at the discretion of a Station:

- Availability may vary by Station  
...
The Service does not currently require in-app purchases to access core functionality. Any future monetization features, if introduced, will be disclosed and implemented in accordance with applicable app store policies.
...
RadioActive may update these Terms from time to time. Updated Terms become effective when posted within the Service or on our website, as indicated by the Effective Date. Continued use of the Service after updates constitutes acceptance of the revised Terms.
